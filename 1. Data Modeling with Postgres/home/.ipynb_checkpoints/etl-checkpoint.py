...
def process_song_file(cur, filepath):
    """
    Process the song data file and add data to song_data and artist_data table.
    Input:
        cur: was connected to db to execute query.
        filepath: path of song data files.
    Output:
        song_data and artist_data tables.
    """
    # open song file
...
def process_log_file(cur, filepath):
    """
    Process the log data file and add data to time_data, user_data and songplay_data tables.
    Input:
        cur: was connected to db to execute query.
        filepath: path of log data files.
    Output:
        song_data, artist_data and songplay_data tables.
    """
    # open log file
    df = pd.DataFrame(pd.read_json( filepath,
                                    lines=True,
    ...
    user_data_clean = user_data[user_data['user_id'].astype(str) != '']
    # remove duplicates
